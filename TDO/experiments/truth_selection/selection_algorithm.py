...
def compute_solution_best_children_final(predicate_info, conf_adapt, conf_adapt_norm, trust_average_adapt, k_expected, first_ranking_criteria, second_ranking_criteria,threshold_list):
	is_coherent = True
	try:
